...
class ByBitAPI:
    ...
    def get_candle_data(self, symbol: str, timeframe: str) -> pd.DataFrame:
        fromTS = int((datetime.now(pytz.timezone(self.TIMEZONE)) - timedelta(minutes=int(timeframe[:-1])*200)).timestamp())
        params = {
            "symbol": symbol,
...
# if __name__ == "__main__":
    # creds = {
    #     "api_key": "yl8m0WFi6lY8UPOdzb",
    #     "api_secret": "Iw85hSyQNrfoHIDMeR8plLPn7xnVujzjOTrG",
    #     "testnet": True
    # }
